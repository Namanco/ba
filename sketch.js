...
function setup(){
    ...
    left = Bodies.rectangle(540,400,10,900,plane_options);
    World.add(world,left)
    right = Bodies.rectangle(10,400,10,900,plane_options);
    ...
    rotator1 = Bodies.rectangle(220,200,150,20,rotator_options);
     World.add(world,rotator1);

    rotator2 = Bodies.rectangle(250,200,150,20,rotator_options);
    World.add(world,rotator2);

    rotator3 = Bodies.rectangle(280,200,150,20,rotator_options);
...
function draw(){
  ...
  rect(left.position.x,left.position.y,10,900);
  rect(right.position.x,right.position.y,10,900);
